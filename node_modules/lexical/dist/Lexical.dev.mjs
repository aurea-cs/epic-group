...
// `"0.48.0+dev.esm"` is statically replaced with the build-specific
// version string in a Rollup build, and a consumer's bundler `define` can
// inject it the same way — so the exact `"0.48.0+dev.esm"` member
...
try {
  envLexicalVersion = "0.48.0+dev.esm";
} catch (_unused) {
