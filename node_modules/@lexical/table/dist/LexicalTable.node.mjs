...
export const $insertTableColumnAtNode = mod.$insertTableColumnAtNode;
...
export const $insertTableRowAtNode = mod.$insertTableRowAtNode;
...
export const $moveTableColumn = mod.$moveTableColumn;
export const $moveTableRow = mod.$moveTableRow;
export const $removeTableRowAtIndex = mod.$removeTableRowAtIndex;
export const $setTableColumnIsHeader = mod.$setTableColumnIsHeader;
export const $setTableRowIsHeader = mod.$setTableRowIsHeader;
export const $unmergeCell = mod.$unmergeCell;
export const $unmergeCellNode = mod.$unmergeCellNode;
...
export const TableImportExtension = mod.TableImportExtension;
export const TableImportRules = mod.TableImportRules;
...
export const TableRowSchema = mod.TableRowSchema;
export const TableSchema = mod.TableSchema;
