...
class TableNode extends lexical.ElementNode {
  ...
  exportDOM(editor) {
    ...
    return {
      ...
      element: !isHTMLTableElement(element) && lexical.isHTMLElement(element) ? element.querySelector('table') : element
    };
  }
  canBeEmpty() {
    return false;
...
const TableRule = /* @__PURE__ */html.defineImportRule({
  $import: (ctx, el) => {
...
const TableRowRule = /* @__PURE__ */html.defineImportRule({
  $import: (ctx, el) => {
...
const TableCellRule = /* @__PURE__ */html.defineImportRule({
  $import: (ctx, el) => {
 ...
 */
const TableExtension = /* @__PURE__ */lexical.defineExtension({
 ...
 * it directly instead.
 */
const TableImportExtension = /* @__PURE__ */lexical.defineExtension({
