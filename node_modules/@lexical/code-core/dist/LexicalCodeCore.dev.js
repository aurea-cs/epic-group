 ...
 * `<td>` pastes.
 */
const GitHubCodeTableOverlayRules = /* @__PURE__ */html.defineOverlayRules([/* @__PURE__ */html.defineImportRule({
  $import: (ctx, el) => ctx.$importChildren(el),
  match: html.sel.tag('tr', 'td'),
  name: '@lexical/code/github-code-table/unwrap'
})]);
const PreRule = /* @__PURE__ */html.defineImportRule({
 ...
 */
const MultilineCodeRule = /* @__PURE__ */html.defineImportRule({
  $import: (ctx, el, $next) => {
 ...
 */
const VscodeWrapperRule = /* @__PURE__ */html.defineImportRule({
  $import: (_ctx, el, $next) => {
 ...
 */
const VscodeLineRunRule = /* @__PURE__ */html.defineImportRule({
  $import: (_ctx, el, $next) => {
    if (!isMonospacePreElement(el) || isMonospaceDescendant(el)) {
      return $next();
    }
 ...
 * CodeNode.
 */
const DivRule = /* @__PURE__ */html.defineImportRule({
  $import: (ctx, el, $next) => {
 ...
 */
const GitHubCodeTableRule = /* @__PURE__ */html.defineImportRule({
 ...
 */
const GitHubCodeCellByClassRule = /* @__PURE__ */html.defineImportRule({
  $import: (ctx, el) => ctx.$importChildren(el),
 ...
 */
const CodeExtension = /* @__PURE__ */lexical.defineExtension({
  dependencies: [
 ...
 * it directly instead.
 */
const CodeImportExtension = /* @__PURE__ */lexical.defineExtension({
 ...
 * own.
 */
const CodeIndentExtension = /* @__PURE__ */lexical.defineExtension({
