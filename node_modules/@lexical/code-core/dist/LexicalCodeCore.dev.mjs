 ...
 * `<td>` pastes.
 */
const GitHubCodeTableOverlayRules = /* @__PURE__ */defineOverlayRules([/* @__PURE__ */defineImportRule({
 ...
 */
const CodeExtension = /* @__PURE__ */defineExtension({
  dependencies: [
 ...
 * it directly instead.
 */
const CodeImportExtension = /* @__PURE__ */defineExtension({
 ...
 * own.
 */
const CodeIndentExtension = /* @__PURE__ */defineExtension({
