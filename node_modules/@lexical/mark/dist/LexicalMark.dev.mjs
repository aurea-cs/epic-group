...
import { ElementNode, $getDocument, addClassNamesToElement, removeClassNamesFromElement, $isRangeSelection, $applyNodeReplacement, $isTextNode, $createRangeSelection, $isElementNode, $isDecoratorNode, defineExtension } from 'lexical';
 ...
 */
const MarkExtension = /* @__PURE__ */defineExtension({
  name: '@lexical/mark',
  nodes: () => [MarkNode]
});
