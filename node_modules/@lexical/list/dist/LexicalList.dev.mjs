...
function $handleListItemBackspaceAdjacentToDecorator() {
  ...
  if (!$isDecoratorNode(previousBlock) || previousBlock.isIsolated() || !(previousBlock.isKeyboardSelectable() || !previousBlock.isInline())) {
    return false;
  }
