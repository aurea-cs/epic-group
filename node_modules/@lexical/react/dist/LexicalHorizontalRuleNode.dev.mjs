...
import { $applyNodeReplacement, mergeRegister, CLICK_COMMAND, getComposedEventTarget, COMMAND_PRIORITY_LOW, addClassNamesToElement, removeClassNamesFromElement } from 'lexical';
