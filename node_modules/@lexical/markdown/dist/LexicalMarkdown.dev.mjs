...
function registerMarkdownShortcuts(editor, transformers = TRANSFORMERS) {
  ...
  return mergeRegister(editor.registerUpdateListener(({
    ...
    if (!$isTextNode(anchorNode) || !dirtyLeaves.has(anchorKey) || !isCompositionEnd && anchorOffset !== 1 && anchorOffset > prevSelection.anchor.offset + 1) {
      return;
    }
    if (isCompositionEnd) {
