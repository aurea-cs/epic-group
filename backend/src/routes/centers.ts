...
// ============================================
// CENTER ↔ PROFESSOR ASSIGNMENTS
// ============================================

// Get professors for a center
router.get('/:centerId/professors', async (req, res) => {
    try {
...
router.post('/:centerId/professors', async (req, res) => {
    try {
        const { centerId } = req.params;
...
router.delete('/:centerId/professors/:userId', async (req, res) => {
    try {
...
// ============================================
// CENTER HIERARCHY VIEW
// ============================================

// Get complete hierarchy for a center
router.get('/:centerId/hierarchy', async (req, res) => {
    try {
        const { centerId } = req.params;
