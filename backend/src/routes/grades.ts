...
router.get('/centers/:centerId/grades', async (req, res) => {
    try {
...
router.get('/grades/:gradeId/students', async (req, res) => {
    try {
...
router.delete('/grades/:gradeId/students/:studentId', async (req, res) => {
    try {
...
// Get all content for a grade (with access control)
router.get('/grades/:gradeId/content', async (req, res) => {
    try {
        const { gradeId } = req.params;
...
// Admin-only grade content endpoint
router.get('/admin/grades/:gradeId/content', async (req, res) => {
    try {
        const { gradeId } = req.params;
...
router.post('/admin/grades/:gradeId/content', upload.array('files', 10), async (req, res) => {
    try {
        const { gradeId } = req.params;
